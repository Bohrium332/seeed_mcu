...
void setup() {
  ...
  /* SPIDF引角拉高 */
  pinMode(SPDIF_PIN, OUTPUT);
  digitalWrite(SPDIF_PIN, HIGH);
  ...
  if (!found_i2c1) {
    Serial0.println("  No I2C1 Grove found");
  }
